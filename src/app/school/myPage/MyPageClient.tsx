  ...
  return (
    <div className="px-4 pb-6 space-y-6">
      ...
      <section aria-labelledby="profile-heading">
        ...
        >
          <div className="w-24 h-24 mr-4 bg-uni-gray-200 rounded-full flex items-center justify-center overflow-hidden relative flex-shrink-0">
            {userData?.image ? (
              <Image src={userProfileImage} alt={`${userData?.name || '사용자'}의 프로필 이미지`} fill style={{ objectFit: 'cover' }} />
            ) : (
              <User className="w-12 h-12 text-uni-gray-500" />
            )}
          </div>
          <div className="text-left">
            <h2 id="profile-heading" className="text-20 font-semibold text-uni-black font-pretendard">{userData?.name || "사용자 이름"}</h2>
      ...
      <section aria-labelledby="activity-summary-heading">
        <div className="bg-uni-white">
          <div className="px-4 py-4 ">
            <h3 id="activity-summary-heading" className="text-18 font-semibold text-uni-black font-pretendard">활동 요약</h3>
          </div>

          <div className="space-y-0">
            <Link
              href="/school/myPage/my-post"
            ...
            <Link
              href="/school/myPage/review-to-write"
              className="flex items-center justify-between py-4 px-4  "
            >
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-uni-blue-100 rounded-lg flex items-center justify-center">
      ...
      <section aria-labelledby="settings-heading">
        <div className="bg-uni-white">
          <div className="px-4 py-4 ">
            <h3 id="settings-heading" className="text-18 font-semibold text-uni-black font-pretendard">상세 정보 및 설정</h3>
          </div>

          <div className="space-y-0">
            <Link
              href="/school/myPage/account"
              className="flex items-center justify-between py-4 px-4  "
            >
              <div className="flex items-center space-x-3">
            ...
            <Link
              href="/school/myPage/notifications"
              className="flex items-center justify-between py-4 px-4  "
            >
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-uni-gray-200 rounded-lg flex items-center justify-center">
